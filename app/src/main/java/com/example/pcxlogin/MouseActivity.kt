...
class MouseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.recyclerViewMouse)
            ...
            .enqueue(object : retrofit2.Callback<List<Product>> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        Toast.makeText(this@MouseActivity, "No products found", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: retrofit2.Call<List<Product>>, t: Throwable) {
                    Toast.makeText(this@MouseActivity, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
                }
            })
    }
}
