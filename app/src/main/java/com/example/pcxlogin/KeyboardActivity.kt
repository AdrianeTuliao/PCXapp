            ...
            .enqueue(object : retrofit2.Callback<List<Product>> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        Toast.makeText(this@KeyboardActivity, "No products found", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: retrofit2.Call<List<Product>>, t: Throwable) {
                    Toast.makeText(this@KeyboardActivity, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
                }
            })
    }
}
