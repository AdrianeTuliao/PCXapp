...
class PcCaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pccase)
        ...
        recyclerView = findViewById(R.id.recyclerViewPcCase)
            ...
            .enqueue(object : retrofit2.Callback<List<Product>> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        Toast.makeText(this@PcCaseActivity, "No products found", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: retrofit2.Call<List<Product>>, t: Throwable) {
                    Toast.makeText(this@PcCaseActivity, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
                }
            })
    }
}
